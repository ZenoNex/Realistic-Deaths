...
public class BlockSkeletonBody extends BlockContainer{

	public BlockSkeletonBody() {
		super(Material.rock);
    	...
    	if(player.inventory.getCurrentItem() != null){
    		if(player.inventory.getCurrentItem().getItem() == ItemManager.CarvingKnife){
    			...
    			if(!par1World.isRemote){
    				...
    				RecipeManager.doManditoryDrops(player, EnumMobType.Skeleton);
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileEntitySkeletonBody();
	}
