...
public class ModelExtendedSlime extends ModelBase
{
    ...
    public ModelExtendedSlime(int par1)
    {
    ...
    public void renderModel(){
    	float f = .0625f;
    	this.slimeBodies.render(f);
    	if(this.slimeRightEye != null){
        	this.slimeRightEye.render(f);
        	this.slimeLeftEye.render(f);
        	this.slimeMouth.render(f);
    	}
    }
