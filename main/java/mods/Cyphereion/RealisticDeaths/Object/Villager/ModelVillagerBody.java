...
public class ModelVillagerBody extends ModelBase
{
    ...
    public ModelVillagerBody(float par1)
    {
        this(par1, 0.0F, 64, 64);
    }

    public ModelVillagerBody(float par1, float par2, int par3, int par4)
    {
