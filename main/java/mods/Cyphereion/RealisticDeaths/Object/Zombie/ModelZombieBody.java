...
public class ModelZombieBody extends ModelBiped
{
    private static final String __OBFID = "CL_00000869";

    public ModelZombieBody()
    {
        this(0.0F, false);
    }

    protected ModelZombieBody(float par1, float par2, int par3, int par4)
    {
        super(par1, par2, par3, par4);
    }

    public ModelZombieBody(float par1, boolean par2)
    {
